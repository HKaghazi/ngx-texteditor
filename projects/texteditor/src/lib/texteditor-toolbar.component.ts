...
@Component({
  selector: 'lib-texteditor-toolbar',
  templateUrl: './texteditor-toolbar.component.html',
  styleUrls: ['./texteditor-toolbar.component.scss']
})
export class TextEditorToolbarComponent {
  ...
  constructor(private r: Renderer2, private editorService: TexteditorService, @Inject(DOCUMENT) private doc: any) { }
        ...
        this.editorService.uploadImage(file).subscribe(
          e => {
            ...
            if (e instanceof HttpResponse) {
              this.editorService.insertImage(e.body.link);
              this.fileReset();
            }
          },
          err => {
